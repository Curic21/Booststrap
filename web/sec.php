    ...
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span9" align="center">
          <div class="hero-unit primer">
              <h2 style="color: #FFFFFF">Secuelas y Precuelas</h2>
          </div>
          <div class="row-fluid">
            <div class="span4" align="center">
                <a href='./img/bellabestia2.jpg'>  <img class="featurette-image pull-left sombra" src="./img/bellabestia2.jpg"></a>
              <p><a class="btn">La Bella y la Bestia 2</a></p>
            </div><!--/span-->
            <div class="span4" align="center">
                <a href='./img/sirenita2.jpg'> <img class="featurette-image pull-left sombra" src="./img/sirenita2.jpg"></a>
              <p><a class="btn">La Sirenita 2</a></p>
            </div><!--/span-->
            <div class="span4" align="center">
                <a href='./img/sirenita3.jpg'>  <img class="featurette-image pull-left sombra" src="./img/sirenita3.jpg"></a>
              <p><a class="btn">La Sirenita 3</a></p>
            </div><!--/span-->
          </div><!--/row-->
          <div class="row-fluid" align="center">
            <div class="span4">
                <a href='./img/reyleon2.jpg'>   <img class="featurette-image pull-left sombra" src="./img/reyleon2.jpg"></a>
              <p><a class="btn">El Rey León 2</a></p>
            </div><!--/span-->
            <div class="span4" align="center">
                <a href='./img/cenicienta3.jpg'>  <img class="featurette-image pull-left sombra" src="./img/cenicienta3.jpg"></a>
              <p><a class="btn">La Cenicienta 3</a></p>
            </div><!--/span-->
            <div class="span4" align="center">
                <a href='./img/tarzan2.jpg'><img class="featurette-image pull-left sombra" src="./img/tarzan2.jpg"></a>
              <p><a class="btn">Tarzán 2</a></p>
            </div><!--/span-->
          </div><!--/row-->
        </div><!--/span-->
      </div><!--/row-->
