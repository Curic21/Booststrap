                ...
                <div class="span9">
                    ...
                    <div class="row-fluid size">
                        <div class="span12" align="center">
                            <a href='./img/corto2.jpg'><img class="featurette-image pull-left sombra" src="./img/corto2.jpg" ></a>
                            <p><a class="btn"></a></p>

                            <div class="pagination" align="center">
                                <ul>
                                    <li>
                                        <a href="corto1.php">Prev</a>
                                    </li>
                                    <li>
                                        <a href="corto.php">1</a>
                                    </li>
                                    <li>
                                        <a href="corto2.php">2</a>
                                    </li>
                                    <li>
                                        <a href="corto3.php">3</a>
                                    </li>
                                    <li>
                                        <a href="corto3.php">Next</a>
                                    </li>
                                </ul>
                            </div>
                        </div><!--/span-->
