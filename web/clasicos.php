...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="http://twitter.github.com/bootstrap/assets/css/bootstrap.css" rel="stylesheet">
     ...
     <style type="text/css">
      ...
      .primer {
          background: url(./img/disneylogo.jpg);  
      }
      .sombra {
      ...
      <div class="row-fluid">
        <div class="span9" align="center">
          <div class="hero-unit primer sombra">
              <h2 style="color: #FFFFFF">Los Clásicos</h2>
          </div>
          <div class="row-fluid">
            <div class="span4" align="center">
                <a href='./img/bellaybestia.jpg'>  <img class="featurette-image pull-left sombra" src="./img/bellaybestia.jpg"></a>
              <p><a class="btn">La Bella y la Bestia</a></p>
            </div><!--/span-->
            <div class="span4" align="center">
                <a href='./img/lasirenita.jpg'> <img class="featurette-image pull-left sombra" src="./img/lasirenita.jpg"></a>
              <p><a class="btn">La Sirenita</a></p>
            </div><!--/span-->
            <div class="span4" align="center">
                <a href='./img/reyleon.jpg'>  <img class="featurette-image pull-left sombra" src="./img/reyleon.jpg"></a>
              <p><a class="btn">El Rey León</a></p>
            </div><!--/span-->
          </div><!--/row-->
          <div class="row-fluid" align="center">
            <div class="span4">
                <a href='./img/aladdin.jpg'>   <img class="featurette-image pull-left sombra" src="./img/aladdin.jpg"></a>
              <p><a class="btn">Aladdín</a></p>
            </div><!--/span-->
            <div class="span4" align="center">
                <a href='./img/blancanieves.jpg'>  <img class="featurette-image pull-left sombra" src="./img/blancanieves.jpg"></a>
              <p><a class="btn">Blancanieves y los 7 Enanitos</a></p>
            </div><!--/span-->
            <div class="span4" align="center">
                <a href='./img/cenicienta.jpg'><img class="featurette-image pull-left sombra" src="./img/cenicienta.jpg"></a>
              <p><a class="btn">La Cenicienta</a></p>
            </div><!--/span-->
          </div><!--/row-->
          <div class="row-fluid" align="center">
            <div class="span4">
                <a href='./img/durmiente.jpg'><img class="featurette-image pull-left sombra" src="./img/durmiente.jpg"></a>
              <p><a class="btn">La Bella Durmiente</a></p>
            </div><!--/span-->
            <div class="span4" align="center">
                <a href='./img/alicia.jpg'> <img class="featurette-image pull-left sombra" src="./img/alicia.jpg"></a>
              <p><a class="btn">Alicia en el Pais de las Maravillas</a></p>
            </div><!--/span-->
            <div class="span4" align="center">
                <a href='./img/Tarzan.jpg'><img class="featurette-image pull-left sombra" src="./img/Tarzan.jpg"></a>
              <p><a class="btn">Tarzán</a></p>
            </div><!--/span-->
            </div><!--/row-->
        </div><!--/span-->
      </div><!--/row-->
