...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <style type="text/css">
            ...
            .tercer {
                background: url(./img/mejores.jpg);
            }
...
<div class="container-fluid">
            <div class="row-fluid">
                <div class="span9">
                    <div class="hero-unit primer sombra" style="height: 60px" >
                        <p><a class="btn btn-primary btn-large" style="width: 200px">Últimos Clásicos</a></p> 
                    </div><!--/row-->
                    <div class="hero-unit segundo sombra" style="height: 60px">
                        <p><a class="btn btn-primary btn-large">Próximos Proyectos</a></p> 
                    </div><!--/row-->
                    <div class="hero-unit tercer sombra" style="height: 60px">
                        <p><a class="btn btn-primary btn-large">Méjores Clásicos</a></p> 
                    </div><!--/row-->
                </div><!--/span-->
